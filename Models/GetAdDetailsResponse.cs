...
namespace Bybit.P2P.Models
{
    public class GetAdDetailsResponse
    {
        ...
        public SymbolInfoClass SymbolInfo { get; set; }

        [JsonProperty("tradingPreferenceSet")]
        public TradingPreferenceSetClass TradingPreferenceSet { get; set; }
        ...
        public partial class SymbolInfoClass
        {
            [JsonProperty("id")]
            public string Id { get; set; }
        ...
        public partial class TradingPreferenceSetClass
        {
